...
#   script, so credit goes to him for a good portion of this.          #
#                                                                      #
#   If you want a good resource on the protocol, see resources.txt     #
#                                                                      #
#                                                                      #
########################################################################
...
# Wakes up the sign and negotiates communication speed
...
ANIMATION_COLOR_DICT = {
    'red': TEXT_COLOR_RED, 'green': TEXT_COLOR_GREEN, 
    'amber': TEXT_COLOR_AMBER, 'dimred': TEXT_COLOR_DIMRED,
    'brown':TEXT_COLOR_BROWN,'orange': TEXT_COLOR_ORANGE,
    'yellow': TEXT_COLOR_YELLOW, 'rainbow1': TEXT_COLOR_RAINBOW1,
    'rainbow2': TEXT_COLOR_RAINBOW2, 'mix': TEXT_COLOR_MIX,
    'autocolor': TEXT_COLOR_AUTO
}

ANIMATION_MODE_DICT = {
    'rotate': MODE_ROTATE, 'hold': MODE_HOLD,
    'flash': MODE_FLASH, 'rollup': MODE_ROLLUP,
    'rolldown': MODE_ROLLDOWN, 'rollleft': MODE_ROLLLEFT,
    'rollright': MODE_ROLLRIGHT, 'wipeup': MODE_WIPEUP,
    'wipedown': MODE_WIPEDOWN, 'wipeleft': MODE_WIPELEFT,
    'wiperight': MODE_WIPERIGHT, 'scroll': MODE_SCROLL,
    'automode': MODE_AUTO, 'rollin': MODE_ROLLIN,
    'rollout': MODE_ROLLOUT, 'wipein': MODE_WIPEIN,
    'wipeout': MODE_WIPEOUT, 'cmprsrot': MODE_CMPRSROT,
    'twinkle': MODE_TWINKLE, 'sparkle': MODE_SPARKLE,
    'snow': MODE_SNOW, 'interlock': MODE_INTERLOCK,
    'switch': MODE_SWITCH, 'spray': MODE_SPRAY, 
    'starburst': MODE_STARBURST, 'welcome': MODE_WELCOME,
    'slotmachine': MODE_SLOTMACHINE, 'newsflash': MODE_NEWSFLASH,
    'trumpet': MODE_TRUMPET, 'thankyou': MODE_THANKYOU,
    'nosmoking': MODE_NOSMOKING,'drinkdrive': MODE_DRINKDRIVE,
    'animal':MODE_ANIMAL, 'fish':MODE_FISH,
    'fireworks': MODE_FIREWORKS, 'turbocar': MODE_TURBOCAR,
    'balloons': MODE_BALLOONS, 'cherrybomb': MODE_CHERRYBOMB
}

# DOTS doesn't work yet
...
def _parse_animations(animations: List[str]):
...
def _parse_animations_from_string(animation_string) -> List[Animation]:
    """
    animation_string should be formatted as such: TEXT ANIMATION_MODE ANIMATION_COLOR ANIMATION_POSITION
    """
    strlist = []
...
def main():
    ...
    animations = _parse_animations_from_string(animations)
    _transmit(PORT, _write_file(animations))
